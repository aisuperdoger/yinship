...
// gcc src/7_demux_decode/07-03-extract-h264.c -o bin/07-03-extract-h264  -g  -L ffmpeg-4.2.7/lib  -l avformat -l avcodec -l avutil -lm -I ffmpeg-4.2.7/include -Wl,-rpath=ffmpeg-4.2.7/lib # 编译
...
int main(int argc, char **argv)
{
    ...
    ifmt_ctx = avformat_alloc_context();   // 我注释掉这块，为什么还是可以运行？  // 这块代码应该可有可无吧
    if (!ifmt_ctx)
    {
